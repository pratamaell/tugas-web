<?php
                            include 'koneksi.php';
                                 $query="SELECT * FROM data_pembeli where id_data='$_GET[id]'";
                                 $result= mysqli_query($koneksi,$query);
                                 $data=mysqli_fetch_array($result);

                                 $query2="SELECT * FROM barang where id_barang='$_GET[id_barang]";
...
<div class="container" style="width: 65%">
    ...
    ?>
        ...
        <div class="table-responsive">
            ...
            Tanggal Pembelian: <?=$data['date_transaksi']?>
            <tr>
    ...
    <center>
        ...
        <table style='width:550px; font-size:8pt; font-family:calibri; border-collapse: collapse;' border='0'>
            <td width='70%' align='left' style='padding-right:80px; vertical-align:top'>
                <br><br>
                <h3 style="color: yellow;padding: 5px;"><b>SAFIRE<i>FURNITURE</i></b></h3><br><br><br>
                <!-- <span style='font-size:12pt'><b>Semata Wayang</b></span></br><br> -->
                Id Transaksi: <?= $_SESSION['id'] ?></br>
        ...
        <table cellspacing='0' style='width:550px; font-size:8pt; font-family:calibri;  border-collapse: collapse;' border='1'>
            ...
            <tr align='center'>
                ...
                $ambil = $koneksi->query("SELECT * From cart Inner Join barang On cart.id_barang = barang.id_barang  WHERE cart.id_pembeli = '$id_pembeli'");
            ...
            <tr>
                ...
                <td style='text-align:right'><?php echo $grand ?></td>
            <tr>
            <?php } ?>
            <td colspan='3'>
                <div style='text-align:right'>Total Yang Harus Di Bayar Adalah : </div>
            </td>
            <td style='text-align:right'><?= $_SESSION['total'] ?></td>
            </tr>
        </table>
        <br><br>
